          ...
          <div className="flex-1 flex flex-col overflow-hidden bg-gray-50">
            ...
            <div className="flex-shrink-0 bg-amber-50 border-b border-amber-200 px-4 py-2">
              <div className="flex items-start gap-2">
                <span className="text-xs font-semibold text-amber-600 mt-0.5 whitespace-nowrap">メモ</span>
                <div className="flex-1 min-w-0">
                  {comments.length > 0 && (
                    <div className="space-y-1 mb-2 max-h-28 overflow-y-auto">
                      {comments.map((c) => (
                        <div key={c.id} className="text-xs text-gray-700 bg-white rounded px-2 py-1 border border-amber-100">
                          <span>{c.body}</span>
